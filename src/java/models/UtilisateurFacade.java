...
public class UtilisateurFacade extends AbstractFacade<Utilisateur> {
    ...
    public Integer findByLogin(String login,String password) {
        try {
            return   (Integer) em.createNativeQuery("SELECT iduser FROM Utilisateur  WHERE loginuser = '"+login+"' AND loginpasswd = MD5('"+password+"')").getSingleResult();
    ...
    public Utilisateur findByIdUser(Integer id) {
        try {
