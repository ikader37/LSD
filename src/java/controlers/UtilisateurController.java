...
public class UtilisateurController extends AbstractBean implements Serializable {
    ...
    public void create() throws Throwable {
        try {
            ...
            //utilisateur.setCreele(UtilisateurController.date());
    ...
    public static Utilisateur getUserConnecte() {
        return UtilisateurController.userConnecte;
    }

    public static void setUserConnecte(Utilisateur userConnecte) {
        UtilisateurController.userConnecte = userConnecte;
    }
